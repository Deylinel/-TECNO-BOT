...
global.owner = [
  ...
  ['50488198573', '🌷 𝓔𝓶𝓶𝓪 𝓥𝓲𝓸𝓵𝓮𝓽𝓼 𝓥𝓮𝓻𝓼𝓲ó𝓷', true],
...
global.nameqr = '𝐓𝐞𝐜𝐧𝐨 - 𝐁𝐨𝐭'
global.sessions = '𝐓𝐞𝐜𝐧𝐨 - 𝐁𝐨𝐭'
global.jadi = '𝐓𝐞𝐜𝐧𝐨 - 𝐁𝐨𝐭'

//• ↳ ◜𝑴𝑨𝑹𝑪𝑨𝑺 𝑫𝑬 𝑨𝑮𝑼𝑨◞ • 💌
global.packsticker = `♾ ━━━━━━━━\n├ ɓσƭ:\n├ ρяοριєταяιο:\n├ ƒєϲнα ∂є ϲяєαϲιόи:\n├ нοяα:\n♾━━━━━━━━`
global.packname = `𝐓𝐞𝐜𝐧𝐨 - 𝐁𝐨𝐭 🚀`
global.author = `♾━━━━━━━━\n⇝͟͞ ۵̤͟𝐓𝐄𝐂𝐍𝐎 - 𝐁𝐎𝐓♡̵̑ ͟͞ ⋆\n⇝ ۵-̱̅𝐃𝐄𝐘𝐋𝐈𝐍-͞ˍ\n⇝ ${moment.tz('America/Los_Angeles').format('DD/MM/YY')}\n⇝ ${moment.tz('America/Los_Angeles').format('HH:mm:ss')} \n♾━━━━━━━━\n\n\n\nѕτιϲκєя ϐγ: ৎ୭࠭͢𝐓𝐄𝐂𝐍𝐎 - 𝐁𝐎𝐓𓆪͟͞ `;
global.wm = 'ৎ୭࠭͢𝐓𝐞𝐜𝐧𝐨 - 𝐁𝐨𝐭𓆪͟͞ ';
global.titulowm = '͟͞ ৎ୭࠭͢𝐓𝐞𝐜𝐧𝐨 - 𝐁𝐨𝐭𓆪 ͟͞';
global.titulowm2 = `͟͞ ৎ୭࠭͢𝐓𝐞𝐜𝐧𝐨 - 𝐁𝐨𝐭𓆪 ͟͞`
global.igfg = '𝐃𝐞𝐲𝐥𝐢𝐧'
global.botname = '𝐓𝐞𝐜𝐧𝐨 - 𝐁𝐨𝐭ᚐ'
global.dev = '𝐓𝐞𝐜𝐧𝐨 - 𝐁𝐨𝐭'
global.textbot = 'ৎ୭࠭͢𝐓𝐞𝐜𝐧𝐨 - 𝐁𝐨𝐭𓆪͟͞ '
global.gt = '͟͞ ৎ୭࠭͢𝐓𝐞𝐜𝐧𝐨 - 𝐁𝐨𝐭 ͟͞';
global.namechannel = '𝐓𝐞𝐜𝐧𝐨 - 𝐁𝐨𝐭'
...
//• ↳ ◜𝑭𝑨𝑲𝑬 𝑬𝑺𝑻𝑰𝑳𝑶◞ • 🪩
global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: '𝐓𝐞𝐜𝐧𝐨 - 𝐁𝐨𝐭', orderTitle: 'Bang', thumbnail: catalogo, sellerJid: '0@s.whatsapp.net'}}}

global.fakegif2 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: 'Tecno - Bot', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: '⚘݄𖠵⃕⁖𖥔.𝐁𝐢𝐞𝐧𝐯𝐞𝐧𝐢𝐝𝐨❞ ꔷ──᜔◇⃟̣̣⃕🚀', jpegThumbnail: logo5 }}};

global.fakegif3 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: 'Tecno Bot', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: '⚘݄𖠵⃕⁖𝐓𝐨𝐧𝐭𝐨 (￣へ ￣ ) 🛸', jpegThumbnail: logo3 }}};

global.fakegif4 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: 'Yuki Suou', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: '𝑻𝒆𝒄𝒏𝒐 - 𝑩𝒐𝒕 🚀ᚐ', jpegThumbnail: logo5 }}};

global.fgif2 = { key: {participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"videoMessage": { "title":𝑫𝒆𝒚𝒍𝒊𝒏, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `𝑻𝒆𝒄𝒏𝒐 - 𝑩𝒐𝒕\n 𝑫𝒆𝒚𝒍𝒊𝒏, 'jpegThumbnail': logo4 }}}
...
//• ↳ ◜𝑳𝑰𝑵𝑲𝑺◞ • 🚀
global.gp4 = 'https://whatsapp.com/channel/0029VawF8fBBvvsktcInIz3m' //Canal Oficial De Tecno - Bot
